...
const onChangeButton = (e) => {
  ...
  return (
    <div className="popUpMakeName">
      <div className="popUpMakeName__inner">
        <div className="popUpMakeName-top">
          <div
            className="popUpMakeName-top__close"
            onClick={props.togglePopUp_MakeNamePlayList}
          >
            <svg
              width="15"
              height="14"
          ...
          <div className="popUpMakeName-top__title">Create playlist</div>
          <button className="popUpMakeName-top__save" onClick={setNamePlayList}>
            Save
          </button>
        </div>
