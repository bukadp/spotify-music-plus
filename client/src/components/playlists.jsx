function PlayLists(props) {
  return (
    <div className="playLists">
      ...
      <button className="playLists__addNew">Add new playlist</button>
      <div className="playLists__list">
        <div className="playLists__list-item">
          <div className="playLists__list-img">PlayList</div>
          <div className="playLists__list-info">
            <div className="playLists__list-name">Name playlist</div>
            <div className="playLists__list-length">14 tracks</div>
          </div>
        </div>
        <div className="playLists__list-item">
          <div className="playLists__list-img">PlayList</div>
